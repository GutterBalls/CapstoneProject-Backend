...
async function createInitialProducts() {
    ...
    // BALLS------------------------------------------
            ...
            { image: "/images/balls/Storm-HP-DNA.png", brand: "Storm", name: "DNA", description: "Storm DNA comes with a Supercoil weight block that was intented for a super low RG shape with a greater undrilled intermediate differential. Which makes it a good Asymmatrical Core new launch bowling ball by Storm. The process of making the coverstock creates caverns of porosity and cliffs so deep which give this state-of-the-art shell.", price: 199.75, sale: true, clearance: false, category_id: 1 },
