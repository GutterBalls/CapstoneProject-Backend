...
async function createInitialProducts() {
    ...
    // BAGS-------------------------------------------
            ...
            { image: "/images/bags/brunswick-blitz-3-org.jpg", brand: "Brunswick", name: "Blitz", description: "The Brunswick Blitz Triple Roller has the best in class base with flush retractable handle system. This roller offers plenty of storage space for all of your bowling accessories. This roller also features a full length shoe compartment. 3 (three) ball roller black orange.", price: 159.66, sale: true, clearance: false, category_id: 2 },
            ...
            { image: "/images/bags/elite-hero-4-blu.jpg", brand: "Elite", name: "4 Ball", description: "The ELITE 4-Ball Bowling Roller bag is a premium bag with room to store four bowling balls, shoes and all the accessories you will ever need. The awesome removable top bag converts to a full functioning 2 ball premium tote! With the 5-inch smooth urethane wheels, you will have the most stable ride in the bowling industry! 4 (four) ball roller black blue.", price: 259.62, sale: false, clearance: true, category_id: 2 },
    ...
    // SHOES--------------------------------------------
            ...
            { image: "/images/shoes/dexter-harper-w.jpg", brand: "Dexter", name: "Harper", description: "The Dexter Womens Harper is part of Dexter's Comfort Casuals Collection. This shoe has a lightweight and breathable design due to the knit fabric upper material. The blending of purple, pink, and blue colors makes this shoe stand out. The padded heel collar, padded tongue, and side vents help make this shoe comfortable. Purple (violet)", price: 89.55, sale: false, clearance: true, category_id: 3 },
