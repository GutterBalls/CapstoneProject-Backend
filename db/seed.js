...
async function createInitialProducts() {
    ...
    // BAGS-------------------------------------------
            ...
            { image: "images/bags/storm-rolling-thunder-2-whtplat.jpg", brand: "Storm", name: "Rolling Thunder", description: "The Storm Rolling Thunder Signature 2 ball roller is designed to look sleek, yet feel powerful. The bag features quality construction for the ultimate rolling experience. 2 (two) ball roller white platinum", price: 179.95, sale: false, clearance: false, category_id: 2 },

            { image: "/images/bags/storm-streamline-3-blk.png", brand: "Storm", name: "Rolling Thunder", description: "Storm has taken their proven high performance 3 ball roller and upgraded the materials to achieve prestige and durability. The Storm Rolling Thunder 3 Ball Roller Signature bag holds nothing back in the style department. This bag has all the high tech features of the Rolling Thunder bags but Storm takes it up a notch in the materials used for this signature bag. 3 (three) ball roller white platinum.", price: 239.95, sale: false, clearance: false, category_id: 2 },
    ...
    // ACCESSORIES-------------------------------------------
            { image: "", brand: "", name: "", description: "", price: 12.34, sale: false, clearance: false, category_id: 4 },
            { image: "", brand: "", name: "", description: "", price: 12.34, sale: false, clearance: false, category_id: 4 },
            { image: "", brand: "", name: "", description: "", price: 12.34, sale: false, clearance: false, category_id: 4 },
            { image: "", brand: "", name: "", description: "", price: 12.34, sale: false, clearance: false, category_id: 4 },
            { image: "", brand: "", name: "", description: "", price: 12.34, sale: false, clearance: false, category_id: 4 },
