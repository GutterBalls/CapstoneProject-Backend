...
async function createInitialProducts() {
    ...
    // ACCESSORIES-------------------------------------------
            ...
            { image: "/images/accessories/brunswick-bionic-positioner.jpg", brand: "Brunswick", name: "Bionic Positioner XF Bowling Glove", description: "The Brunswick Bionic Wrist Positioner XF offers several wrist cup and lateral positions to best suit your game. The extended index finger provides additional rotation potential. This positioner is is made of durable aluminum materials that make it lightweight and comfortable.", price: 56.49, sale: false, clearance: false, category_id: 4 },
            ...
            { image: "/images/accessories/kr-strikeforce-ball-sanding-pad.jpg", brand: "KR Strikeforce", name: "Abralon Bowling Ball Sanding Pad", description: "Do you need to sand your ball down to a different finish? If so this could be the perfect sanding pad for you. It can be used wet, or dry. It works great with Powerhouse Ball Resurface. This sanding pad will last 5 times longer than sandpaper.", price: 7.34, sale: false, clearance: true, category_id: 4 },   
        ];
